...
- 📱 Building Android apps with **Kotlin** & **Jetpack** ecosystem
- 🤖 Exploring **Machine Learning** & **Deep Learning**
- ☁️ Learning **Cloud Computing** & DevOps practices
- 🌱 Currently mastering **Android Development** end-to-end
...
- 📱 **Student Room Sharing App** — Redesigning and adding new features
- 🤖 **Machine Learning** — Exploring computer vision & AI-powered Android apps
- ☁️ **Cloud Computing** — Learning deployment & cloud-native development
